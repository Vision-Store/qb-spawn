...
## Screenshots
![Spawn selector](https://imgur.com/mc1SzU2.png)
...
## Installation
### Manual
- Replace the config..lua and the entire html folder to recieve the new improved style
```
ensure qb-core
ensure qb-spawn
ensure qb-apartmen
